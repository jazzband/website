...
def upgrade():
    ...
    op.create_index(
        op.f('ix_project_members_is_lead'),
        'project_members', ['is_lead'],
        unique=False
    )
    op.create_table(
        'project_uploads',
        ...
        sa.UniqueConstraint('sha256_digest'), sa.UniqueConstraint('signature')
    )
    op.create_index(
        op.f('ix_project_uploads_filename'),
        'project_uploads', ['filename'],
        unique=True
    )
    op.create_index(
        op.f('ix_project_uploads_path'),
        'project_uploads', ['path'],
        unique=True
    )
    op.create_index(
        op.f('ix_project_uploads_version'),
        'project_uploads', ['version'],
        unique=False
    )
    op.create_index(
        'project_uploads_project_version',
        'project_uploads', ['project_id', 'version'],
        unique=False
    )
    op.add_column(
        'projects',
...
def downgrade():
    ...
    op.drop_index(
        'project_uploads_project_version', table_name='project_uploads'
    )
    op.drop_index(
        op.f('ix_project_uploads_version'), table_name='project_uploads'
    )
    op.drop_index(op.f('ix_project_uploads_path'), table_name='project_uploads')
    op.drop_index(
        op.f('ix_project_uploads_filename'), table_name='project_uploads'
    )
    op.drop_table('project_uploads')
    op.drop_index(
        op.f('ix_project_members_is_lead'), table_name='project_members'
    )
