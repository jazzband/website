...
def upgrade():
    ...
    op.add_column('project_uploads', sa.Column('notified_at', sa.DateTime(), nullable=True))
    op.add_column('project_uploads', sa.Column('ordering', sa.Integer(), nullable=True))
    op.create_index(op.f('ix_project_uploads_notified_at'), 'project_uploads', ['notified_at'], unique=False)
