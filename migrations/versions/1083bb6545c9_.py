...
def upgrade():
    ...
    op.create_index(op.f('ix_project_memberships_is_lead'), 'project_memberships', ['is_lead'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_project_memberships_is_lead'), table_name='project_memberships')
