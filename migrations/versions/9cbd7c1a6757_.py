...
def upgrade():
    ...
    op.add_column('users', sa.Column('age_consent', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    op.add_column('users', sa.Column('consented_at', sa.DateTime(), nullable=True))
    op.add_column('users', sa.Column('cookies_consent', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    ...
    op.add_column('users', sa.Column('org_consent', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    op.add_column('users', sa.Column('profile_consent', sa.Boolean(), server_default=sa.text('false'), nullable=False))
