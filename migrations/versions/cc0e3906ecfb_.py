...
def upgrade():
    ...
    op.create_index(op.f("ix_users_is_member"), "users", ["is_member"], unique=False)
    op.create_index(op.f("ix_users_is_roadie"), "users", ["is_roadie"], unique=False)
    ...
    op.create_index(
        op.f("ix_email_addresses_primary"), "email_addresses", ["primary"], unique=False
    )
    op.create_index(
...
def downgrade():
    ...
    op.drop_index(op.f("ix_email_addresses_verified"), table_name="email_addresses")
    op.drop_index(op.f("ix_email_addresses_primary"), table_name="email_addresses")
